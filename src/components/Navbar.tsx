  ...
  return (
    <TooltipProvider>
      <motion.nav
        ...
        className="h-screen bg-[#111827] border-r border-white/10 flex flex-col p-4 sticky top-0 z-50 overflow-hidden shrink-0 shadow-[20px_0_50px_rgba(0,0,0,0.5)]"
      >
          ...
          <Link href="/quiz" className="mt-auto">
            ...
            >
              <div className="relative shrink-0">
                ...
                <span className="absolute inset-0 bg-purple-500 rounded-full animate-ping opacity-50"></span>
              </div>
              <AnimatePresence>
                {expanded && (
                  <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="font-bold whitespace-nowrap truncate shrink-0">
                    Resume Quiz
                  </motion.span>
                )}
              </AnimatePresence>
